                            ...
                            <div class="form-group">
                              <label class="form-label">Link</label>
                                <div class="input-group input-group-outline mb-3">
                                    <input type="text" class="form-control" required data-parsley-pattern="^((http|https):\/\/.)[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)$" name="link"  value="{{$data['link']}}" required>
                                  </div>
                            </div>
                        </div>
                    </div>
                      ...
                      <div class="col-md-8">
                        <div class="form-group">
                            <label for="oldpassword">Icon<span style="color:red;" >*</span></label>
                               <p>
                                <img src="{{ Config::get('DocumentConstant.SOCIALMEDIAICON_VIEW') }}{{ $data['image'] }}" height="50px" width="60px">
                              </p>
                                <div class="input-group input-group-outline mb-3">
