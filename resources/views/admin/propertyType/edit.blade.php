                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="oldpassword">Property Type Image<span style="color:red;" >*</span></label>
                                   <p>
                                    <img src="{{ Config::get('DocumentConstant.PROPERTY_TYPE_VIEW') }}{{ $data['image'] }}" height="50px" width="60px">
                                  </p>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Total Area</label><span style="color:red;" >*</span>
                              <div class="input-group input-group-outline mb-3">
                                  <input type="text" class="form-control" name="total_area" value="{{ $data['total_area'] }}" data-parsley-error-message="Please enter valid total area." data-parsley-pattern="^[a-z A-Z 0-9.]+$" required="true">
                                </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="col-md-8">
                        <div class="form-group">
                          <label class="form-label">Plot Area</label><span style="color:red;" >*</span>
                            <div class="input-group input-group-outline mb-3">
                                <input type="text" class="form-control" name="plot_area" value="{{ $data['plot_area'] }}"  data-parsley-error-message="Please enter valid plot area." data-parsley-pattern="^[a-z A-Z 0-9 .]+$" required="true">
                              </div>
                        </div>
                    </div>
                </div>
                  ...
                  <div class="col-md-8">
                      <div class="form-group">
                        <label class="form-label">Location</label><span style="color:red;" >*</span>
                          <div class="input-group input-group-outline mb-3">
                              <textarea  class="form-control" name="location"  data-parsley-error-message="Please enter valid location." data-parsley-pattern="^[a-z A-Z 0-9 .]+$" required="true">{{ $data['location'] }}</textarea>
                            </div>
                      </div>
                  </div>
              </div>
