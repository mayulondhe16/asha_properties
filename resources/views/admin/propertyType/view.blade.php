              ...
              <form action="{{ url('/')}}/view_{{$url_slug}}/{{$data['id']}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="oldpassword">Property Type Image<span style="color:red;" >*</span></label>
                                   <p>
                                    <img src="{{ Config::get('DocumentConstant.PROPERTY_TYPE_VIEW') }}{{ $data['image'] }}" height="200px" width="300px"> 
                                  </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-footer">
                        <a href="{{url('/')}}/manage_property_type" type="submit" class="btn btn-primary pull-right">Back</a>
                    </div>
                  </form>
            </div>
          </div>
