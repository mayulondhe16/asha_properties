                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label for="oldpassword">Image<span style="color:red;" >*</span></label>
                                   <p>
                                    <img src="{{ Config::get('DocumentConstant.REVIEW_VIEW') }}{{ $data['image'] }}" height="50px" width="60px">
                                  </p>
                      ...
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Reviewer Name</label><span style="color:red;" >*</span>
                              <div class="input-group input-group-outline mb-3">
                                  <input type="text" class="form-control" name="reviewer_name" value="{{ $data['reviewer_name'] }}" data-parsley-error-message="Please enter valid total area." data-parsley-pattern="^[a-z A-Z 0-9.]+$" required="true">
                                </div>
                          </div>
                      </div>
                  </div>
