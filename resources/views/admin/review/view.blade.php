              ...
              <form action="{{ url('/')}}/view_{{$url_slug}}/{{$data['id']}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-8">
                          <div class="form-group">
                            <label class="form-label">Reviewer Name</label><span style="color:red;" >*</span>
                              <div class="input-group input-group-outline mb-3">
                                  <input type="text" class="form-control" name="reviewer_name" readonly value="{{ $data['reviewer_name'] }}" data-parsley-error-message="Please enter valid total area." data-parsley-pattern="^[a-z A-Z 0-9.]+$" required="true">
                                </div>
                          </div>
                      </div>
                  </div>
                    ...
                    <div class="box-footer">
                        <a href="{{url('/')}}/manage_review" type="submit" class="btn btn-primary pull-right">Back</a>
                    </div>
                  </form>
            </div>
          </div>
